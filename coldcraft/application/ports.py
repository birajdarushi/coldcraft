...
from ..domain.models import DraftResult, NormalizedJob
...
class CampaignRepositoryPort(Protocol):
    ...
    def save_job(self, job: NormalizedJob) -> tuple[str, bool]: ...
...
class IntelResearchPort(Protocol):
    def generate(self, company: str) -> dict[str, dict]: ...


class JobScraperPort(Protocol):
